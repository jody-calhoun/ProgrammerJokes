...
{
  public class JokesMigrationsConfiguration
    : DbMigrationsConfiguration<JokesContext>
  {
    public JokesMigrationsConfiguration()
    {
      this.AutomaticMigrationDataLossAllowed = true;
      this.AutomaticMigrationsEnabled = true;
    }

    protected override void Seed(JokesContext context)
    {
      base.Seed(context);
